...
To authenticate with the Fingertip API, add an `Authorization` header to your requests. Your API key should be included directly in the header value. You can obtain an API key from [https://fingertip.com/api-keys](https://fingertip.com/api-keys).
